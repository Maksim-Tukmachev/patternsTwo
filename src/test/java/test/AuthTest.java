...
class AuthTest {
    ...
    void shouldSuccessfullyLoginWithActiveRegiseredUser(){
    ...
    void shouldGetErrorIfNotRegiseredUser (){
    ...
    @Test
    @DisplayName("Should get error message if login with block registered user")
    void shouldGetErrorIfBlockUser (){
